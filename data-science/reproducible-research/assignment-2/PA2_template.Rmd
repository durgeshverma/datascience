...
* For part 1, data table columns FATALITIES and INJURIES are aggregated by event types (columnn name: EVTYPE), and then output data is arranged in new data table that consists of three columns: Event Type (EVTYPE), Count of fatalities / injuries (COUNT), type. Two different charts are drawn using this data table to summarize the results.
